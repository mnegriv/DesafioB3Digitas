...
namespace CurrencyIngestion.Test.Service
{
    public class CurrencySummaryCalculatorTests
    {
        ...
        public void Test1()
        {
            ...
            var average = new List<decimal> { 72926.1m, 72927.1m, 72922.1m, 72906.1m }.Average();

            Assert.Equal(72927.1m, summary.HighestPrice);
        ...
        public void Test2()
        {
            ...
            Assert.Equal(72927, summary.HighestPrice);
            Assert.Equal(72906, summary.LowestPrice);
